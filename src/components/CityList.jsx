              ...
              <div className="city-wrapper">
                {cities.map((city, index) => (
                  ...
                  <div key={city.id} className="city-cell" style={{ maxWidth: openCity === city.name ? "100%" : "30%", order: (index + 1) % 2 !== 0 ? 2 : 1, }} >
                    ...
                    <h2>{city.name}</h2> <div className="icon"> <img 
      src={openCity === city.name ? '../src/assets/minus.svg' : '../src/assets/icon.svg'} 
      alt="city"
    /></div></div>
                    </div>
                    {openCity === city.name && (
                          <div className="accordion-body" style={{ padding: "10px",maxWidth:"100%", }}>
